...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Super Admin'), ('ADMIN', 'Admin'), ('OPERATIONS_ADMIN', 'Operations Admin'), ('FINANCE_ADMIN', 'Finance Admin'), ('SUPPORT_ADMIN', 'Support Admin'), ('VERIFICATION_ADMIN', 'Verification Admin'), ('RENTER', 'Renter'), ('OWNER', 'Owner'), ('DRIVER', 'Driver'), ('SERVICE_PROVIDER', 'Service Provider')], max_length=30)),
